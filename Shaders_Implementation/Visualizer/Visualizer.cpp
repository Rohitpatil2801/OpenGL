...
Visualizer::Visualizer(QWindow* parent) : QMainWindow(nullptr)
{
    ...
    connect(mpushButtonScaleUp, &QPushButton::clicked, this, &Visualizer::scaleUpClicked);
    connect(mpushButtonScaleDown, &QPushButton::clicked, this, &Visualizer::scaleDownClicked);
...
//--------------------------------------------------------------Sutherland---------------------------------------------
    ...
    mpushButtonScaleUp = new QPushButton(tab2);
    mpushButtonScaleUp->setObjectName("mpushButtonScaleUp");
    mpushButtonScaleUp->setText("Scale Up");
    mpushButtonScaleUp->setGeometry(QRect(320, 160, 100, 25));

    mpushButtonScaleDown = new QPushButton(tab2);
    mpushButtonScaleDown->setObjectName("mpushButtonScaleDown");
    mpushButtonScaleDown->setText("Scale Down");
    mpushButtonScaleDown->setGeometry(QRect(320, 200, 100, 25));
...
void Visualizer::scaleUpClicked()
{
    ...
    if (mRenderer)
    {
        mRenderer->setScaleFactor(0.3); // You can adjust the scaling factor
    }
}
